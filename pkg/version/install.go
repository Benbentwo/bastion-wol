...
import (
	"fmt"
	"github.com/Benbentwo/bastion-wol/pkg/github"
...
func (o *VersionOptions) InstallBin(upgrade bool, prefix string, version string) error {
	...
	// BinaryDownloadBaseURL := "https://github.com/Benbentwo/bastion-wol/releases/download/v1.0.0/
	// 							 https://github.com/Benbentwo/bastion-wol/releases/download/v1.0.0/go-bin-generic-windows-amd64.zip"
